...
public partial class UI_Reports_ReportsOptions : System.Web.UI.Page
{
    ...
    private void AddAttributes()
    {
        ...
        hlSummaryEPRSavingReport.Attributes.Add("onclick", "LoadReport('" + Konstants.Report.Name.ePRPSavingSummaryReport + "');");
        hlSummaryEPRSavingReportByMU.Attributes.Add("onclick", "LoadReport('" + Konstants.Report.Name.ePRPSavingSummaryReportByMU + "');");
    }
    private void ShowMenuItems()
    {
        try
        {
            ...
            trSummaryEPRSavingReport.Visible = ((UserPassport)Session["UserPassport"]).HasPRReportsRights;
            ...
            trSummaryEPRSavingReportByMU.Visible = true;
        }
        catch (Exception ex)
        {
