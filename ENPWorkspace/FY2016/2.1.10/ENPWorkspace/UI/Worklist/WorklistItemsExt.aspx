<%@ Page Language="C#" AutoEventWireup="true" CodeFile="WorklistItemsExt.aspx.cs" Inherits="UI_Worklist_WorklistItemsExt" %>
                            ...
                            <td valign="top">
                                 <table style="width:100%" cellpadding="0" cellspacing="0">
                                    ...
                                    <td style="text-align:right; vertical-align:middle;" rowspan="2">
                                        <asp:ImageButton ID="ibtnRefresh" runat="server" Height="16px" ImageUrl="~/Images/refresh.JPG"  ToolTip="Refresh" Width="16px" AlternateText="Refresh" BackColor="White" BorderStyle="Solid" BorderWidth="0" BorderColor="#92AEC9" Visible="False" />
                                        &nbsp;
                                    </td>                                        
                                    </tr>
                                    <tr>
