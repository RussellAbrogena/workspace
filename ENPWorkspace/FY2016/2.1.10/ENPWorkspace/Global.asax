...
<script runat="server">
    ...
    void Application_Error(object sender, EventArgs e)
    {
        ...
        Response.Redirect(System.Configuration.ConfigurationManager.AppSettings["ErrorPageUrl"] + "?errtype=" + Emerson.WF.Konstants.ErrorMessage.SystemError);

    }

    void Session_Start(object sender, EventArgs e)
    {
        UserPassport userPassport = new UserPassport("EMRSN\\dbonoan");
