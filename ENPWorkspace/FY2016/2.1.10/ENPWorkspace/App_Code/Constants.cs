    ...
    public class Konstants
    {
        ...
        public struct Report
        {
            public struct Name // IMPT: String values should EXACTLY correspond to the name of the .rdl file
            {
                ...
                public const string TSRPrintForm = "TSRPrintForm";
                ...
                public const string TSRAdminReport = "TSR Admin Report";
                public const string TSRMUReport = "TSR MU Report";
                public const string TSRSummaryReportNonFormatted = "TSR Raw Data Report";
                public const string TSRSummaryReportFormatted = "TSR Summary Report";
                public const string HRTSummaryReport = "HCRSummaryReports";
                public const string HRTMonthlyReport = "HCR Summary Monthly Reports";
                public const string HRTApprovedReport = "HRT Approved Requests Summary";
                public const string HRTPendingReport = "HRT Pending Request Summary";
                public const string EEPSummaryReport = "EEP Summary Reports";
                public const string ePRPrintForm = "ePRPrintForm";
                public const string ePRPSavingSummaryReport = "ePRSummarySavingReport";
                public const string ePRPSavingSummaryReportByMU = "ePRSummarySavingReportByMU";
            }
            ...
            public struct DisplayName
            {
                ...
                public const string ePRPrintFrom = "ePR Print From";
                public const string ePRPSavingSummaryReport = "Summary of Purchase Requisition Savings Report";
                public const string ePRPSavingSummaryReportByMU = "Summary of Purchase Requisition Savings Report by MU";
                ...
                public const string TSRSummaryReportFormatted = "TSR Summary Report (Formatted)";
                public const string TSRSummaryReportNonFormatted = "TSR Summary Report (Non-Formatted)";
                public const string TSRAdminReport = "TSR Admin Report";
                public const string TSRMUReport = "TSR MU Report";

                public const string HRTSummaryReport = "Headcount Requests Summary Report";
                public const string HRTMonthlyReport = "Headcount Requests Monthly Report";
                public const string HRTApprovedReport = "Approved Headcount Requests Summary Report";
                public const string HRTPendingReport = "Pending Headcount Requests Summary Report";

                public const string EEPSummaryReport = "Employee Exit Summary Report";
        ...
        public struct ProcessName
        {
            ...
            public const string EEP3 = "Employee Exit Request 3.0";
            public const string TRP2 = "Travel Request Process 2.0";
            public const string CAPEX3 = "CAPEX Request Process 3.0";
            ...
            public const string TSR = "TimeSure Request";
            public const string HRT = "Headcount Recruitment and Tracking Process";
            public const string EPR = "Purchase Requisition";
            public const string TRP3 = "Travel Request Process 3.0";
        }
        /* END Error Message Types */
