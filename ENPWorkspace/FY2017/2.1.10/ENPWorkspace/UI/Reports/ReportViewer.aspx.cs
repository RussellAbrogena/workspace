...
#region ENPCountryList
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        switch (ReportName)
        {
            ...
            case Konstants.Report.Name.ePRPSavingSummaryReport:
                {
                    lblReportName.Text = Konstants.Report.DisplayName.ePRPSavingSummaryReport;
                    break;
                }
            case Konstants.Report.Name.ePRPSavingSummaryReportByMU:
                {
                    ReportName = Konstants.Report.Name.ePRPSavingSummaryReport;
                    lblReportName.Text = Konstants.Report.DisplayName.ePRPSavingSummaryReportByMU;
                    break;
                }
            ...
            case Konstants.Report.Name.TSRAdminReport:
                {
                    ...
                    trCalendarYear.Visible = true;
                    txtTSRYear.Text = DateTime.Now.Year.ToString();
    ...
    protected void btnViewReport_Click(object sender, EventArgs e)
    {
        ...
        switch (ReportName)
        {
            ...
            case Konstants.Report.Name.ePRPSavingSummaryReport:
                {
                    ParamValues = @"marketUnit_=" + Country + "&dtfrom=" + SubmittedDateFrom + "&dtto=" + SubmittedDateTo;
                    break;
                }
            case Konstants.Report.Name.ePRPSavingSummaryReportByMU:
                {
            ...
            case Konstants.Report.Name.TSRAdminReport:
                {
                    ParamValues = @"WeekFrom=" + txtStartWeek.Text + "&iYear=" + txtTSRYear.Text;
                    break;
                }
            case Konstants.Report.Name.HRTSummaryReport:
                {
            ...
            case Konstants.Report.Name.HRTApprovedReport:
                {
                    ...
                    ParamValues = @"dtDateFrom=" + SubmittedDateFrom + "&dtDateTo=" + (Convert.ToDateTime(SubmittedDateTo).AddDays(1)).ToShortDateString() + "&strCountry=" + strCountry;
                    break;
                }
            case Konstants.Report.Name.EEPSummaryReport:
                {
