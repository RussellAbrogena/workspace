...
public partial class UI_Worklist_WorklistItems : System.Web.UI.Page
{
    ...
    protected void gvWorklistItems_PageIndexChanging(object sender, GridViewPageEventArgs e)
    {
        ...
        //gvWorklistItems.DataSource = (DataTable)ViewState["ProcInst"];
        //gvWorklistItems.DataBind();
    ...
    {
        //Response.Write(gvWorklistItems.SelectedIndex.ToString());
    ...
    {
        // 12/19/07 abrs
        //gvWorklistItems.DataSource = SortDataTable(gvWorklistItems.DataSource as DataTable, true);
    ...
    public void HandleSorting(object sender, GridViewSortEventArgs e)
    {
        ...
        // 12/19/07 abrs
        //gvWorklistItems.DataSource = SortDataTable(gvWorklistItems.DataSource as DataTable, false);
