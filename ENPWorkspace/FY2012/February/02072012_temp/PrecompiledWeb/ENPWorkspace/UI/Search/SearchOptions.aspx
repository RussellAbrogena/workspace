<%@ page language="C#" autoeventwireup="true" inherits="UI_Search_SearchOptions, App_Web_searchoptions.aspx.187d51b8" %>
...
<head runat="server">
    ...
    function DeleteSavedSearch()
    {
        ...
        if (confirm("Delete Saved Search '" + document.getElementById('cboSavedSearch').value + "' ?   "))
          ...
          function fieldCheck(obj, message)
          {
          var msg = '';
          //alert(obj.value);
          if(obj.value.replace(/^\s*([\S\s]*?)\s*$/, '$1') == '')
          ...
          msg += fieldCheck(txtSearch, 'Search For Field');
          //alert(msg);
          if(msg != '')
          {
            alert(msg);
          ...
          var hasCheck = 'false';
          var chklProcess = document.getElementById('<%=chklProcess.ClientID %>');
          var checkbox = chklProcess.getElementsByTagName("input");
          ...
          if(hasCheck == 'false')
          {
              alert('At least 1 process must be checked');
              return false;
          }
          return true;
          }
												            ...
												            <tr>
													            <td valign="top" style="width: 180px">
                                                                    <asp:Button ID="btnSearch" runat="server" CssClass="ms-button" Height="22px" Text="Search"
                                                                        Width="44%" OnClick="btnSearch_Click" OnClientClick="return SearchFieldNotEmpty()"/>
