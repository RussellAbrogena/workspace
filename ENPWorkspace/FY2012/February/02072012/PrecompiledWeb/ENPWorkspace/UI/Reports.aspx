<%@ page language="C#" autoeventwireup="true" inherits="Reports, App_Web_reports.aspx.76ff77b3" %>
...
<head id="Head1" runat="server">
    <title>ENP Workspace - Reports</title>
						...
						<tr>
							...
							<td style="height:100%; width:200px; background-color:#CAD2E0">
							    ...
							    <table border="0" cellspacing="2" cellpadding="2" style="width: 200px;">
									<tr>
									    <td>
									        <iframe id="MenuFrame" src="Menu/MenuItems.aspx?cursel=Reports" scrolling="auto" frameborder="0" width="100%" height="83px" allowtransparency="true">
						                	</iframe>
									    </td>
									</tr>
									...
									<tr style="width:100%; height:481px;" valign="top">
									    ...
									    <table cellspacing="0" cellpadding="0" width="100%" border="1" style=" background-color:White; height:100%; border-color:#1e3c7c;">
									            <tr>
                                                    ...
                                                    <iframe id="ReportsOptionsFrame" src="Reports/ReportsOptions.aspx" frameborder="0" width="100%" height="481px" style="overflow-y:auto; overflow-x: hidden;">
							                        </iframe>
										            </td>
									            </tr>								
								            </table>
