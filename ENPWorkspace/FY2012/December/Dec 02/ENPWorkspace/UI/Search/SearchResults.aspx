<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SearchResults.aspx.cs" Inherits="UI_Search_SearchResults" %>
                                                        ...
                                                        <asp:TemplateField HeaderText="Start Date (GMT+8)" SortExpression="StartDate">
                                                            ...
                                                            <ItemTemplate>
                                                                <asp:LinkButton ID="lbtnStartDate" runat="server" CommandName="Select" CausesValidation="false"
                                                                    Font-Underline="false" Text='<%# String.Format(Emerson.WF.Constants.DateFormat.TimeDate, Eval("StartDate")) %>'></asp:LinkButton>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
