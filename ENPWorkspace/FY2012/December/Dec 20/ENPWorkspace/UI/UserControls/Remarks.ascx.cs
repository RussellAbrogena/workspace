...
public partial class UserControls_Remarks : System.Web.UI.UserControl
{
    ...
    public void ShowDataFields(bool isDraft)
    {
        ...
        Show_Remarks(isDraft, K2SQLDA.GetProcInstDataFieldValue(ProcInstID, Constants.DataField.Remarks),
           K2SQLDA.GetProcInstDataFieldValue(ProcInstID, Constants.DataField.Remarks));
    }
