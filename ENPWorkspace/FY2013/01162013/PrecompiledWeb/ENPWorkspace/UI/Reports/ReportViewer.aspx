<%@ page language="C#" autoeventwireup="true" inherits="UI_Reports_ReportViewer, App_Web_reportviewer.aspx.76412409" %>
...
<head id="Head1" runat="server">
    ...
    function CheckEmployeeFilter(sender, args)
    {
        for(var i=0; i<document.form1.elements.length; i++)
        {
            if (document.form1.elements[i].name.indexOf("<%= chkEmployee.ID.ToString() %>") >= 0)
                if(document.form1.elements[i].checked)
                {
                    args.IsValid = true;
                    return;
                        ...
                        <tr>
                            <td valign="top" style="height: 572px; width: 100%;">
                                <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                      ...
                                      <tr id="tr1" runat="server">
                                       ...
                                       <tr id="trTraveller" runat="server">
                                        ...
                                        <tr id="trFlight" runat="server">
                                        <td style="padding-left: 20px; height: 21px; width: 350px; background-color: white;" class="Report-filtertitle">
                                            <asp:Label id="Label4" runat="server" Width="164px" Text="Flight Details"></asp:Label>
                                            <table cellpadding="0" cellspacing="0" style="width: 100%; height: 50px">
                                                <tr>
                                                    <td align="left" class="Report-td" style="width: 414px" valign="middle">
                                                        &nbsp; &nbsp;&nbsp;&nbsp;
                                                        <asp:TextBox ID="txtFlight" runat="server" CssClass="ms-input" Width="288px"></asp:TextBox></td>
                                                </tr>
                                            </table>  
                                        </td>
                                      </tr>
                                        <tr id="trAccomodation" runat="server">
                                        <td style="padding-left: 20px; height: 21px; width: 350px; background-color: white;" class="Report-filtertitle">
                                            <asp:Label id="Label5" runat="server" Width="164px" Text="Accomodation"></asp:Label>
                                            <table cellpadding="0" cellspacing="0" style="width: 100%; height: 50px">
                                                <tr>
                                                    <td align="left" class="Report-td" style="width: 414px" valign="middle">
                                                        &nbsp; &nbsp;&nbsp;&nbsp;
                                                        <asp:TextBox ID="txtAccomodation" runat="server" CssClass="ms-input" Width="288px"></asp:TextBox></td>
                                                </tr>
                                            </table>  
                                        </td>
                                      </tr>
                                   <%--   <tr id="trHotelName" runat="server">
                                      ...
                                      <tr id="trDateFilter" runat="server">
                                        ...
                                        <tr id="trTRPFlightDate" runat="server">
                                        <td style="padding-left: 20px; width: 350px; height: 73px;" class="Report-filtertitle">
                                            &nbsp;<asp:Label ID="Label14" runat="server" Text="Flight Date"></asp:Label>
                                              <table cellpadding="0" cellspacing="0" style="width: 100%">
                                                <tr>
                                                    <td class="Report-td" style="height: 30px;" align="left" valign="middle">
                                                        &nbsp;<asp:Label ID="Label15" runat="server" Text="From" Style="font-weight: normal;" CssClass="Report-fieldtitle"></asp:Label>
                                                       <asp:TextBox CssClass="ms-input" ID="txtTRPFlightStartDate" runat="server" Width="70px"></asp:TextBox>
                                                        <img id="imgTRPFlightStartDate" runat="server" alt="" height="16" src="../../Images/calendarButton.gif" style="width: 16px; height: 16px" width="16" />
                                                        &nbsp;&nbsp;
                                                        <asp:Label ID="Label16" runat="server" Text="To" Style="font-weight: normal;" CssClass="Report-fieldtitle"></asp:Label>
                                                        <asp:TextBox CssClass="ms-input" ID="txtTRPFlightEndDate" runat="server" Width="70px"></asp:TextBox>
                                                        <img id="imgTRPFlightEndDate" runat="server" alt="" height="16" src="../../Images/calendarButton.gif" style="width: 16px; height: 16px" width="16" /></td>
                                                </tr>
                                    ...
                                    <tr id="trInitiatedRequests" runat="server">
                                       ...
                                       <tr id="trTRPEmployee" runat="server">
                                        <td style="padding-left: 20px; height: 21px; width: 350px;" class="Report-filtertitle">
                                            <asp:Label id="Label17" runat="server" Width="164px" Text="Emerson Employee?"></asp:Label>
                                            <table cellpadding="0" cellspacing="0" style="width: 100%; height: 50px">
                                                <tr>
                                                    <td align="left" class="Report-td" style="width: 414px" valign="middle">
                                                        <asp:CheckBoxList ID="chkEmployee" runat="server" RepeatColumns="2" CssClass="Report-fieldtitle">
                                                            <asp:ListItem Value="True" Selected="True">Yes</asp:ListItem>
                                                            <asp:ListItem Value="False" Selected="True">No</asp:ListItem>
                                                        </asp:CheckBoxList></td>
                                                </tr>
                                            </table>
                                                <asp:CustomValidator ID="cvTRPEmployee" runat="server" ClientValidationFunction="CheckEmployeeFilter"
                                                    ErrorMessage="At least one Employee Filter should be selected.   " Display="None" CssClass="ms-errormessage"></asp:CustomValidator>&nbsp;<br />
                                        </td>
                                      </tr>  
                                   ...
                                   <tr id="trApprovedDeniedRequests" runat="server">
                                    <td style="padding-left: 20px; height: 21px; width: 350px;" class="Report-filtertitle">
                                       ...
                                       <tr id="trPRType" runat="server" style="height:10px;">
                                       <td style="padding-left: 20px; width: 350px;" class="Report-filtertitle">
                                            <asp:Label id="lbPRType" runat="server" Text="PR Type Filter"></asp:Label>
                                            <table cellpadding="0" cellspacing="0" style="width: 100%">
                                                <tr>
                                                <td class="Report-td" style="width: 200px; height: 50px;" align="left" valign="middle">
                                                    &nbsp; &nbsp;&nbsp;
                                                    <asp:DropDownList ID="ddlPRType" runat="server" CssClass="Report-fieldtitle" Width="150px">
                                                        <asp:ListItem Selected="True">-- All --</asp:ListItem>
                                                        <asp:ListItem>Direct Material</asp:ListItem>
                                                        <asp:ListItem>Indirect Material</asp:ListItem>
                                                    </asp:DropDownList></td>
                                                </tr>
                                            </table>
                                            <br />
                                    ...
                                    <td style="padding-left: 20px; height: 21px; width: 350px;" class="Report-filtertitle">
                                        ...
                                        <td style="padding-left: 20px; width: 350px;" class="Report-filtertitle">
                                         ...
                                         <tr id="trCountryFilterDDL" runat="server">
                                        <td style="padding-left: 20px; width: 350px;" class="Report-filtertitle">
                                            <asp:Label id="lblCountryDDL" runat="server" Text="Market Unit"></asp:Label>
                                            <table cellpadding="0" cellspacing="0" style="width: 100%; height: 12px;">
                                                <tr>
                                                    <td class="Report-td" style="width: 200px; height: 50px;" align="left" valign="middle">
                                                        &nbsp; &nbsp;&nbsp;
                                                        <asp:DropDownList ID="ddlCountry" runat="server" CssClass="Report-fieldtitle" Width="150px" AutoPostBack="True" OnSelectedIndexChanged="ddlCountry_SelectedIndexChanged"></asp:DropDownList>
                                                    </td>
                                                </tr>
                                            </table>
                                    </td>
                                      ...
                                      <tr id="trARTypeFilter" runat="server" style="height:10px;">
                                       ...
                                       <tr id="trPRNumber" runat="server">
                                        <td style="padding-left: 20px; height: 21px; width: 350px; background-color: white;" class="Report-filtertitle">
                                            <asp:Label id="lbPRNumber" runat="server" Width="164px" Text="PR Number"></asp:Label>
                                            <table cellpadding="0" cellspacing="0" style="width: 100%; height: 50px">
                                                <tr>
                                                    <td align="left" class="Report-td" style="width: 414px" valign="middle">
                                                        &nbsp; &nbsp;&nbsp;&nbsp;
                                                        <asp:TextBox ID="txtPRNumber" runat="server" CssClass="ms-input" Width="288px"></asp:TextBox></td>
                                                </tr>
                                            </table>  
                                        </td>
                                      </tr>
                                    <tr runat="server" id="trContractType">
                                        <td class="Report-filtertitle" style="padding-left: 20px; width: 350px; height: 21px;
                                            background-color: white">
                                            <asp:Label ID="lblContractType" runat="server" Text="Contract Type" Width="164px"></asp:Label>
                                            <table cellpadding="0" cellspacing="0" style="width: 100%; height: 50px">
                                                <tr>
                                                    <td align="left" class="Report-td" style="width: 414px" valign="middle">
                                                        &nbsp; &nbsp; &nbsp;
                                                        <asp:DropDownList ID="ddlContractType" runat="server" CssClass="Report-fieldtitle" Width="150px" AutoPostBack="True">
                                                            <asp:ListItem Selected="True">-- Select --</asp:ListItem>
                                                            <asp:ListItem>Sales</asp:ListItem>
                                                            <asp:ListItem>Services</asp:ListItem>
                                                            <asp:ListItem>Sales &amp; Services</asp:ListItem>
                                    ...
                                    <tr runat="server" id="trStartWeek" visible="false">
                                        <td class="Report-filtertitle" style="padding-left: 20px; width: 350px; height: 21px;
                                            background-color: white">
                                            <asp:Label ID="Label18" runat="server" Text="Start Week" Width="164px"></asp:Label>
                                            <table cellpadding="0" cellspacing="0" style="width: 100%; height: 50px">
                                                <tr>
                                                    <td align="left" class="Report-td" style="width: 414px" valign="middle">
                                                        &nbsp; &nbsp; &nbsp; &nbsp;
                                                        <asp:TextBox ID="txtStartWeek" runat="server" CssClass="ms-input" Width="49px"></asp:TextBox>
                                                    </td>
                                                </tr>
                                            </table>
                                            <br>
                                    ...
                                    <tr runat="server" id="trCalendarYear" visible="false">
                                        <td class="Report-filtertitle" style="padding-left: 20px; width: 350px; height: 21px;
                                            background-color: white">
                                            <asp:Label ID="Label19" runat="server" Text="Calendar Year" Width="164px"></asp:Label>
                                            <table cellpadding="0" cellspacing="0" style="width: 100%; height: 50px">
                                                <tr>
                                                    <td align="left" class="Report-td" style="width: 414px" valign="middle">
                                                        &nbsp; &nbsp; &nbsp; &nbsp;
                                                        <asp:TextBox ID="txtTSRYear" runat="server" CssClass="ms-input" Width="49px"></asp:TextBox>
                                                    </td>
                                                </tr>
                                            </table>
                                            <br>
                                ...
                                <asp:ValidationSummary ID="ValidationSummary1" runat="server" ShowMessageBox="True"
                                    ...
                                    <asp:TextBox style="DISPLAY: none" ID="hdnCountry" runat="server"></asp:TextBox>
                                            </td>
                                      </tr>                                      
                                </table>
                            </td>
