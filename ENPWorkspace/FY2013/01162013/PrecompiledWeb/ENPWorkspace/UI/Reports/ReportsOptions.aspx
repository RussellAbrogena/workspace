<%@ page language="C#" autoeventwireup="true" inherits="UI_Reports_ReportsOptions, App_Web_reportsoptions.aspx.76412409" %>
    ...
    <table cellspacing="2" cellpadding="4" border="0" style="vertical-align: top; width: 100%; height:100%">
												            ...
												            <tr id="trReportsOptions">
													            ...
													            <%--    <tr id="trReportBuilder" runat="server"><td>
													                ...
													                <tr style="height:8px;"><td></td></tr>
													                 <tr id="trEEP" runat="server"><td style="height: 15px">
													                <span><u><b>Employee Exit</b></u></span>
													                </td></tr>
													                 <tr id="trEEPSummaryRpt" runat="server"><td valign="top">
													                <span style="font-family:Wingdings 3; font-size:8px">u</span>&nbsp;&nbsp;<asp:HyperLink ID="hlEEPSummaryRpt" runat="server"  NavigateUrl="#">EEP Summary Report</asp:HyperLink>
													                </td></tr>													                
													                
													                 <tr style="height:8px;"><td></td></tr>
													                 <tr id="trHRT" runat="server"><td style="height: 15px">
													                <span><u><b>Headcount Request</b></u></span>
													                </td></tr>
													                 <tr id="trHRTSummaryRpt" runat="server"><td valign="top">
													                <span style="font-family:Wingdings 3; font-size:8px">u</span>&nbsp;&nbsp;<asp:HyperLink ID="hlHRTSummaryRpt" runat="server"  NavigateUrl="#">Summary of Requests</asp:HyperLink>
													                </td></tr>
													                 <tr id="trHRTMonthlyRpt" runat="server"><td valign="top">
													                <span style="font-family:Wingdings 3; font-size:8px">u</span>&nbsp;&nbsp;<asp:HyperLink ID="hlHRTMonthlyRpt" runat="server"  NavigateUrl="#">Monthly Report</asp:HyperLink>
													                </td></tr>
													                 <tr id="trHRTApprovedRpt" runat="server"><td valign="top">
													                <span style="font-family:Wingdings 3; font-size:8px">u</span>&nbsp;&nbsp;<asp:HyperLink ID="hlHRTApprovedRpt" runat="server"  NavigateUrl="#">Approved Requests Summary</asp:HyperLink>
													                </td></tr>
													                 <tr id="trHRTPendingRpt" runat="server"><td valign="top">
													                <span style="font-family:Wingdings 3; font-size:8px">u</span>&nbsp;&nbsp;<asp:HyperLink ID="hlHRTPendingRpt" runat="server"  NavigateUrl="#">Pending Requests Summary</asp:HyperLink>
													                </td></tr>													                													                													                													                
													                ...
													                <tr id="trSummaryEPRSavingReport" runat="server"><td style="height: 15px">
													                <span style="font-family:Wingdings 3; font-size:8px">u</span>&nbsp;&nbsp;<asp:HyperLink ID="hlSummaryEPRSavingReport" runat="server"  NavigateUrl="#">Summary of Purchase Requisition Savings Report</asp:HyperLink>
													                </td></tr>
													                ...
													                <tr id="trSummaryEPRSavingReportByMU" runat="server"><td style="height: 15px">
													                <span style="font-family:Wingdings 3; font-size:8px">u</span>&nbsp;&nbsp;<asp:HyperLink ID="hlSummaryEPRSavingReportByMU" runat="server"  NavigateUrl="#">Summary of Purchase Requisition Savings Report By MU</asp:HyperLink>
													                </td></tr>
													                ...
													                <tr id="trTimeSURE" runat="server"><td style="height: 15px">
													                <span><u><b>TimeSURE Request</b></u></span>
													                </td></tr>
													                <tr id="trTSRSummaryRep1" runat="server"><td style="height: 15px">
													                <span style="font-family:Wingdings 3; font-size:8px">u</span>&nbsp;&nbsp;<asp:HyperLink ID="hlTSRRequestSummaryFormatted" runat="server"  NavigateUrl="#">Summary of Requests (formatted)</asp:HyperLink>
													                </td></tr>
													                <tr id="trTSRSummaryRep2" runat="server"><td style="height: 15px">
													                <span style="font-family:Wingdings 3; font-size:8px">u</span>&nbsp;&nbsp;<asp:HyperLink ID="hlTSRRequestSummaryNonFormatted" runat="server"  NavigateUrl="#">Summary of Requests (non-formatted)</asp:HyperLink>
													                </td></tr>
													                <tr id="trTSRAdminRep" runat="server"><td style="height: 15px">
													                <span style="font-family:Wingdings 3; font-size:8px">u</span>&nbsp;&nbsp;<asp:HyperLink ID="hlTSRAdminReport" runat="server"  NavigateUrl="#">Admin Report</asp:HyperLink>
													                </td></tr>
													                <tr id="trTSRMURep" runat="server"><td style="height: 15px">
													                <span style="font-family:Wingdings 3; font-size:8px">u</span>&nbsp;&nbsp;<asp:HyperLink ID="hlTSRMUReport" runat="server"  NavigateUrl="#">Market Unit Report</asp:HyperLink>
													                </td></tr>													                													                
