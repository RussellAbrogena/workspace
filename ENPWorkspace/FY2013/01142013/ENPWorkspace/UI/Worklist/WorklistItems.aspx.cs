...
public partial class UI_Worklist_WorklistItems : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            //ItemsDataSource = k2SQLDA.GetProcInstancesOfUser(WorklistItemIDs, ProcessFilter, "emrsn\\dflor");

            ItemsDataSource = SqlHelper.ExecuteDataset(ConfigurationManager.AppSettings["Emerson.WF.SQLUtilities.SQLHelper.ConnectionString"],
              "sp_DirectGetWorklistItems", ProcessFilter, Page.User.Identity.Name.ToString()).Tables[0];
        }
